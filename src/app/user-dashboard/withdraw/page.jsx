export default function Withdraw(){
    return (
        <div className="p-24 m-80 mt-40 mb-0 bg-gray-100 rounded-xl" id="withdraw">
            <form>
                ...
                <button className="block m-8 p-8 pt-4 pb-4 bg-gray-300 rounded-3xl shadow-xl hover:bg-gray-200 ">Withdraw</button>
            </form>
        </div>
    )
}