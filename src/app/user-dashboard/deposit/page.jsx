...
export default function Deposit() {
  ...
  return (
    <div className="mb-0 rounded-xl" id="deposit">
      ...
      <label className="block p-4 px-0 pb-1 font-semibold">Deposit Token:</label>
      ...
      <div className="border flex justify-between items-center bg-transparent w-full border-slate-700 rounded-2xl py-1 px-2 pl-3 outline-none transition-all duration-300 focus:border-blue-500">
        ...
        />{" "}
        <div className="relative w-10 p-2 cursor-pointer text-left shadow-md focus:outline-none border border-grey-500 rounded-xl sm:text-sm">
          <Image
            src={usdt}
            alt="usdt"
            className="w-6 h-6"
      ...
      <Button
        variant={"outline"}
        className="py-3 px-6 mt-8 gap-2 rounded-2xl border bg-[#0267FF] text-white text-sm w-fit"
        translate="no"
      >
        Deposit
      </Button>
